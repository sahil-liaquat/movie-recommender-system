...
This section describes the main files used in the project and their purposes.
...
- Shows the top 5 recommended movies in a clean, multi-column layout.  

---

### 📓 `notebook86c26b4f17.ipynb`
- Jupyter Notebook used for **data preprocessing and model training**.  
- Performs feature extraction, text processing, and similarity computation.  
- Generates and exports required pickle files for the app (`movie_list.pkl` and `similarity.pkl`).  

---

### 📁 `model/movie_list.pkl`
- Pickle file containing **processed movie data**.  
- Includes movie titles, IDs, and the combined feature tags used for similarity comparison.  

---

### 📁 `model/similarity.pkl`
- Pickle file storing the **cosine similarity matrix** between all movies.  
- Enables fast retrieval of the most similar movies during app runtime.  

---

### 🧾 `requirements.txt` *(optional)*
- Contains a list of all required Python dependencies.  
- Can be used for quick setup with:
  ```bash
